...
import com.goya.demo.helpers.waitHelper;
...
public class dashBoardXpath extends userHomePage {
    ...
    public WebElement pop_up_Submit_order;
    ...
    @FindBy(how = How.XPATH, using = "//input[@id='exampleInputName2']")
    public WebElement exampleInputName;
